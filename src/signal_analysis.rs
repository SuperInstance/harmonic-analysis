//! Signal analysis: detect periodic patterns in signal.
...
/// Detected periodic pattern in signal.
...
/// Signal analysis for detecting periodic patterns in signal.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SignalAnalysis;

impl SignalAnalysis {
    /// Analyze signal signal for periodic patterns.
    /// `signal` is a time series of signal metrics.
    ...
    /// Generate a synthetic signal signal with known periodicity.
